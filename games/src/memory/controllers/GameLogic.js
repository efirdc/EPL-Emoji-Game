    ...
    comboBreaker() {
        for (let comboPair of this.comboCards) {
            if (!comboPair.first.isAfraid) {
                this.setCardPhase(comboPair.first, CardPhase.COMBO_BREAKER);
                this.setCardPhase(comboPair.second, CardPhase.COMBO_BREAKER);
            }
        }
